...
const Mail = () => {
  ...
  const sendEmail = (values) => {
    ...
    emailjs.sendForm('service_50my90o', 'template_g7nhzdq', document.getElementById("#myForm"), 'PmEa6BoX3zJ1n-2pa', { attachment: attachmentData })
      .then((result) => {
    ...
    >
     <Form.Item
      ...
      <Form.Item label="Archivo" name="attachment">
        <input type="file" name="attachment" onChange={handleFileChange} defaultValue=""/>
      </Form.Item>
      <Form.Item
        wrapperCol={{
          ...layout.wrapperCol,
