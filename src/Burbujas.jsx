...
export default function Chart(datos) {
  ...
  useEffect(() => {
    ...
    function createBubble(x, y, r, color, word, porcentaje, maxSize= Infinity) {
  ...
  smallerData.forEach((datum, index) => {
    ...
    const bubble = createBubble(x, y, datum.value, color, datum.word, datum.porcentaje); // Pasar la propiedad porcentaje
